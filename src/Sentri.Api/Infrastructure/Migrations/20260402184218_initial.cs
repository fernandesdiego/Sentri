        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarningThreshold = table.Column<decimal>(type: "numeric(4,2)", precision: 4, scale: 2, nullable: false, defaultValue: 0.8m),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Snapshots_Providers_ProviderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Expenses_Snapshots_SnapshotId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Snapshots_ProviderId_Year_Month",
                table: "Snapshots",
                columns: new[] { "ProviderId", "Year", "Month" },
                unique: true);
